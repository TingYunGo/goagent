...
extern const ReplaceItem* TingyunReplaceItems() {
    static ReplaceItem targets[] = {
        ...
        {"database/sql.Open", "/database.WrapDBOpen", "", 0},
        {"database/sql.(*DB).Close", "/database.WrapDBClose", "", 0},
        {"database/sql.(*Conn).PrepareContext", "/database.WrapConnPrepareContext", "", 0},
        {"database/sql.(*Conn).QueryContext", "/database.WrapConnQueryContext", "", 0},
        {"database/sql.(*Conn).ExecContext", "/database.WrapConnExecContext", "", 0},
        {"database/sql.(*DB).PrepareContext", "/database.WrapDBPrepareContext", "", 0},
        {"database/sql.(*DB).QueryContext", "/database.WrapDBQueryContext", "", 0},
        {"database/sql.(*DB).ExecContext", "/database.WrapDBExecContext", "", 0},
        {"database/sql.(*Tx).PrepareContext", "/database.WrapTxPrepareContext", "", 0},
        {"database/sql.(*Tx).QueryContext", "/database.WrapTxQueryContext", "", 0},
        {"database/sql.(*Tx).ExecContext", "/database.WrapTxExecContext", "", 0},
        {"database/sql.(*Stmt).QueryContext", "/database.WrapStmtQueryContext", "", 0},
        {"database/sql.(*Stmt).ExecContext", "/database.WrapStmtExecContext", "", 0},
