...
func makeLoginRequest() ([]byte, error) {
	...
	return json.Marshal(map[string]interface{}{
		"host":                  getHost(),
		"appName":               readLocalConfigString(configLocalStringNbsAppName, "TingYunDefault"),
		"language":              "Go",
		...
		"pid":                   os.Getpid(),
		"firstRun":              firstRun,
		"defaultBusinessSystem": readLocalConfigString(configLocalStringDefaultBusinessSystem, "default"),
		"environment": map[string]interface{}{
			"config": map[string]interface{}{
				"license_key":       getLicense(&app.configs),
				"nbs.log_file_name": readLocalConfigString(configLocalStringNbsLogFileName, "agent.log"),
				"audit":             readLocalConfigBool(configLocalBoolAudit, false),
				"nbs.max_log_count": readLocalConfigInteger(configLocalIntegerNbsMaxLogCount, 3),
				"nbs.max_log_size":  readLocalConfigInteger(configLocalIntegerNbsMaxLogSize, 10),
				"nbs.ssl":           readLocalConfigBool(configLocalBoolSSL, false),
			},
			"env": envInfo,
			...
			"meta": map[string]interface{}{
				...
				"agentVersion":  TINGYUN_GO_AGENT_VERSION,
				"tingyun.debug": false,
				"UUID":          readLocalConfigString(configLocalStringAppUUID, ""),
			},
		},
	})
}
